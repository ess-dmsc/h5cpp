...
//                        bat "rd /s /q _build"
                ...
                dir("_build") {
                    try {
                        bat "C:\\Users\\dmgroup\\AppData\\Local\\Programs\\Python\\Python36\\Scripts\\conan.exe install -f..\\conanfile_default.txt --build=outdated -s compiler="Visual Studio" -s compiler.version=14"
                    } catch (e) {
