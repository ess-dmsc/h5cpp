    ...
    if(HDF5_${_lang}_COMPILER_NO_INTERROGATE)
      ...
      if(HDF5_${_lang}_COMPILER_EXECUTABLE)
        ...
        if(HDF5_${_lang}_RETURN_VALUE EQUAL 0)
          ...
          set(HDF5_${_lang}_FOUND TRUE)
          if(HDF5_${_lang}_DEFINITIONS)
            list(REMOVE_DUPLICATES HDF5_${_lang}_DEFINITIONS)
          endif()
          if(HDF5_${_lang}_INCLUDE_DIRS)
            list(REMOVE_DUPLICATES HDF5_${_lang}_INCLUDE_DIRS)

	    set(_TMP_INC_DIR)
	    foreach( _dir IN LISTS HDF5_${_lang}_INCLUDE_DIRS )
              if( EXISTS "${_dir}" )
		list(APPEND _TMP_INC_DIR  "${_dir}")
	      endif()
	    endforeach()
	    set(HDF5_${_lang}_INCLUDE_DIRS ${_TMP_INC_DIR})
	    unset(_dir)
	    unset(_TMP_INC_DIR)
...
elseif(NOT HDF5_FOUND AND NOT _HDF5_NEED_TO_SEARCH)
  ...
  if (HDF5_INCLUDE_DIRS)
    ...
    endforeach()
    set(HDF5_INCLUDE_DIRS ${_TMP_INC_DIR})
    unset(_TMP_INC_DIR)
    unset(_dir)
  endif()
  set(HDF5_FOUND TRUE)
