...
if (DO_COV)
    ...
    if (NOT GCOV_PATH OR NOT GCOVR_PATH)
        ...
        add_custom_target(coverage_base COMMAND ${GCOVR_PATH} "-r" "${CMAKE_SOURCE_DIR}/" "-x" ${gcovr_excl_opts} "-o" "${CMAKE_BINARY_DIR}/tests/coverage.xml" DEPENDS runtest)
        add_custom_target(coverage_xml COMMAND ${GCOVR_PATH} "-r" "${CMAKE_SOURCE_DIR}/" "-x" ${gcovr_excl_opts} "-o" "${CMAKE_BINARY_DIR}/tests/coverage.xml" DEPENDS runtest)
        add_custom_target(coverage_html COMMAND ${GCOVR_PATH} "-r" "${CMAKE_SOURCE_DIR}/" "--html" "--html-details" ${gcovr_excl_opts} "-o" "${CMAKE_BINARY_DIR}/tests/index.html" DEPENDS runtest)
